...
class AddPostView(CreateView):
    ...
    def form_valid(self, form):
        ...
        # Update shoe count after adding a new post
        shoe_count = Post.objects.filter(author=user).count()
        ...
        if badge_awarded:
            return redirect('members:badge_success', badge_name=badge_awarded)  # Ensure 'members' is the app name
